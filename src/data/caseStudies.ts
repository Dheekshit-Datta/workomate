...
export const caseStudies = [
  {
    ...
    fullContent: {
      ...
      solution: "We built a multi-agent sales system on Trigger.dev, designed to handle every stage of the outbound workflow, from sourcing leads to writing the first line of a cold email, without manual intervention.\n\nThe system integrates Apify for LinkedIn scraping, Jina AI for web intelligence, and Supabase as the central lead database, with Instantly + Apollo managing email sequences and warm-up.\n\n**The system, four agents:**\n\n• **Scraping Agent** Pulls ICP-matched leads from LinkedIn Sales Navigator via Apify and Apollo. Filters by industry, headcount, role, and location. Feeds raw data into Supabase.\n\n• **Enrichment Agent** Uses Jina AI and Serper to read company websites, recent posts, and ad activity. Builds a context profile for each lead, what they're running, what's missing.\n\n• **Qualification Agent** Scores leads against Growzzy's ICP criteria, ad spend signals, current agency use, growth stage. Removes unqualified leads before any email is sent.\n\n• **Copywriting Agent** Writes a personalised first line and full cold email for each lead using enrichment data. Pushes final copy into Instantly / Expandi sequences, ready to send.",
  ...
  },
  {
    ...
    fullContent: {
      ...
      techStack: ["Retell AI", "Trigger.dev", "Modal (deployment)", "Hotel PMS Integration (Opera/Cloudbeds)", "Claude API", "Custom POS Connector"],
    },
  },
];
