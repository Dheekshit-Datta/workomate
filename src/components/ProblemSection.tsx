...
const ProblemSection = () => {
  ...
  return (
    <section className="py-16 md:py-20 px-4 sm:px-6 bg-card border-b border-border" ref={ref}>
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
        ...
        <div className="w-full lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
          {problems.map(({ icon: Icon, title, desc }, i) => (
            <div
              key={title}
              className={`skeu-card p-5 sm:p-6 transition-all duration-700 hover:scale-[1.03] hover:shadow-lg ${
