      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10">
          {steps.map(({ num, title, desc }, i) => (
            <div
              key={num}
              className={`flex flex-col items-start border-l-2 border-border pl-8 relative transition-all duration-600 ${visible ? "translate-y-0 opacity-100" : "translate-y-12 opacity-0"}`}
            ...
            >
              ...
              <h3 className="text-2xl md:text-3xl font-medium text-foreground tracking-tight mb-3 mt-0.5">{title}</h3>
