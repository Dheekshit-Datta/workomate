...
const ServicesSection = () => (
  <section id="services" className="py-16 md:py-20 px-4 sm:px-6 bg-gradient-to-b from-[hsl(207,80%,95%)] to-[hsl(210,60%,90%)] border-b border-border relative overflow-hidden">
    ...
    <div className="max-w-6xl mx-auto relative z-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-6 max-w-5xl mx-auto">
        {/* Lead Gen Card */}
        <div className="skeu-card p-5 sm:p-6 flex flex-col">
            ...
            <div className="bg-card rounded-xl shadow-sm border border-border p-3 sm:p-4 w-full max-w-sm h-full flex flex-col justify-between relative z-10">
              ...
              <div className="flex items-end justify-between gap-1.5 h-20 mt-auto w-full px-1">
                {[30, 45, 65, 85, 100].map((h, i) => (
                  <div key={i} className="w-full rounded-t" style={{ height: `${h}%`, opacity: 0.4 + i * 0.15, backgroundColor: `hsl(217 91% ${70 - i * 8}%)` }} />
                ))}
              </div>
            </div>
          </div>
