...
const CTASection = ({ onBookAudit }: CTASectionProps) => (
  <section className="py-16 md:py-24 px-4 sm:px-6 bg-transparent border-b border-border">
    <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
      ...
      {/* Case Studies CTA */}
      <div className="skeu-card-dark p-6 sm:p-10 md:p-12 flex flex-col items-start justify-between relative overflow-hidden group">
